...
export default async function DashboardPage() {
  ...
  return <main style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 20px' }}>
    ...
    <section style={{ marginTop: 24, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 }}>
      <div style={{ border: '1px solid #24282f', borderRadius: 16, background: '#111419', padding: 22 }}><h2 style={{ marginTop: 0 }}>Schedule reminder</h2><ReminderEditor tasks={tasks.map(task => ({ id: task.id, title: task.title }))} /></div>
      <div style={{ border: '1px solid #24282f', borderRadius: 16, background: '#111419', padding: 22 }}><h2 style={{ marginTop: 0 }}>Upcoming reminders</h2><ReminderList reminders={reminders} /></div>
    </section>
  </main>
}
